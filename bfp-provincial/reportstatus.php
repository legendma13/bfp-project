                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="reporttable" class="table table-striped">
                        ...
                        <?php $i=0?>
                        <tbody>
                          <?php $Qform1 = mysqli_query($link,"SELECT * FROM m_report 
                          WHERE M_uid = '$uid' ORDER BY M_report_submit DESC")?>
                          <?php while($shform1 = mysqli_fetch_assoc($Qform1)){?>
                            <?php $i++?>
                          <tr>
                            <td><?php echo $i?></td>
                            <td><?php echo $shform1['M_report_name']?></td>
                            <td><?php echo $shform1['M_start_report']?></td>
                            <td><?php echo $shform1['M_end_report']?></td>
                            <td>
                              <?php if ($shform1['M_report_status'] == "Requesting") {
                                echo '<span class="badge bg-warning">' . $shform1['M_report_status'] . '</span>';
                              } elseif($shform1['M_report_status'] == "Approved") {
                                echo '<span class="badge bg-primary">' . $shform1['M_report_status'] . '</span>';
                              } else {
                                echo '<span class="badge bg-success">' . $shform1['M_report_status'] . '</span>';
                              }?>
                            </td>
                            <td><?php echo $shform1['M_report_submit']?></td>
                            <td>
                              <a href="municipal-report.php?rid=<?php echo $shform1['M_report_id']?>&start=<?php echo $shform1['M_start_report']?>&end=<?php echo $shform1['M_end_report']?>">
                                <button type="button" class="btn btn-primary p-2 text-white">
                                  View
                                </button>
                              </a>
                              <?php if ($shform1['M_report_status'] == "Need Edit") {?>
                                <button class="btn btn-warning p-2" data-bs-toggle="modal" data-bs-target="#commentmodal<?php echo $i?>">View Comment</button>
                                <button type="button" value="<?php echo $shform1['M_report_id']?>" 
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <?php echo $shform1['M_report_comment']?>
                                </div>
            ...
            <div class="modal-content">
              ...
              <form id="reportform" class="modal-body">
                <dl class="row">
                  <dt class="col-lg-6">
                    Report Name
                    <input type="text" class="form-control" name="reportname" value="<?php echo $sh_user['municipal']." Report-".rand()?>" placeholder="Type here...">
                  </dt>
                  <dt class="col-lg-3">
                ...
                <dl class="row">
                  <dt class="col-lg-12">  
                    Report Details
                    <textarea name="reportdetail" id="summernote"></textarea>
                  </dt>
                </dl>
              </form>
              <div class="modal-footer">
