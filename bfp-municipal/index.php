                ...
                <div class="home-tab">
                  ...
                  <div class="tab-content tab-content-basic">
                    ...
                    <?php $query = mysqli_fetch_assoc($link->query("SELECT COUNT(CASE WHEN report_status='Approved' THEN 1 END) as 'approved', 
                      ...
                      WHERE bfp_users.uid = '".$sh_user['uid']."'"))?>
                      <div class="row mb-3">
                        <div class="col-lg-4">
                            ...
                            <div class="card-header fw-bold d-flex justify-content-between">
                              ...
                              <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="reportstatus.php">View Report</a></li>
                                </ul>
                              </div>
                            </div>
                          ...
                          <div class="row flex-row flex-nowrap">
                            <div class="card me-3">
                              ...
                              <script>
                                ...
                                WHERE form1_date_added BETWEEN '$a-1-1 00-00-01' AND '$a-12-$lastday 23-59-59' AND uid='$uid'"));
                                ...
                                WHERE form2_date_added BETWEEN '$a-1-1 00-00-01' AND '$a-12-$lastday 23-59-59' AND uid='$uid'"));
                                ...
                                WHERE form3_date_added BETWEEN '$a-1-1 00-00-01' AND '$a-12-$lastday 23-59-59' AND uid='$uid'"));
                              ...
                              <script>
                                ...
                                var yArray = [<?php 
                                              while($datamonthnow != $dataminus5month){
                                                ...
                                                WHERE form1_date_added BETWEEN '$monthofth 00-00-01' AND '$monthofth1 23-59-59' AND uid='$uid'"));
                                ...
                                var zArray = [<?php 
                                              while($datamonthnow != $dataminus5month){
                                                ...
                                                WHERE form2_date_added BETWEEN '$monthofth 00-00-01' AND '$monthofth1 23-59-59' AND uid='$uid'"));
                                ...
                                var cArray = [<?php 
                                              while($datamonthnow != $dataminus5month){
                                                ...
                                                WHERE form3_date_added BETWEEN '$monthofth 00-00-01' AND '$monthofth1 23-59-59' AND uid='$uid'"));
                        ...
                        <div class="col-lg-4">
                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              WHERE form1_date_added BETWEEN '$yearngayon 00-00-01' AND '$yearngayonlastday 23-59-59' AND uid = '$uid'"))?>
                              <?php $reviewsmonth = mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(form1_id) FROM bfp_form1 
                              WHERE form1_date_added BETWEEN '$dataminus1year 00-00-01' AND '$dataminus1yearlastday 23-59-59' AND uid = '$uid'"))?>

                              <?php $be = mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(form2_id) FROM bfp_form2 
                              WHERE form2_date_added BETWEEN '$yearngayon 00-00-01' AND '$yearngayonlastday 23-59-59' AND uid = '$uid'"))?>
                              <?php $be2 = mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(form2_id) FROM bfp_form2 
                              WHERE form2_date_added BETWEEN '$dataminus1year 00-00-01' AND '$dataminus1yearlastday 23-59-59' AND uid = '$uid'"))?>

                              <?php $ge = mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(form3_id) FROM bfp_form3 
                              WHERE form3_date_added BETWEEN '$yearngayon 00-00-01' AND '$yearngayonlastday 23-59-59' AND uid = '$uid'"))?>
                              <?php $ge2 = mysqli_fetch_assoc(mysqli_query($link,"SELECT COUNT(form3_id) FROM bfp_form3 
                              WHERE form3_date_added BETWEEN '$dataminus1year 00-00-01' AND '$dataminus1yearlastday 23-59-59' AND uid = '$uid'"))?>
