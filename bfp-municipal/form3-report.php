            ...
            <div class="col-sm-12">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#Overview" role="tab" aria-controls="Overview" aria-selected="true">
                        GOVERNMENT BUILDINGS Report For <?php echo $_GET['year'] . "-" . $_GET['month'] ?>
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="row mb-3" id="newstabshow">
                ...
                ?>
                  ...
                  <div class="col-lg-6 mt-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND uid='$uid' AND type = 'New' AND form3_status = '1'"))?>
                        <?php $counttyperenew = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND uid='$uid' AND type = 'Renew' AND form3_status = '1'"))?>
                        <?php $counttypenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                        WHERE form3_date_added BETWEEN '$l' AND '$l1' AND uid='$uid' AND type = 'New' AND form3_status = '1'"))?>
                        <?php $counttyperenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                        WHERE form3_date_added BETWEEN '$l' AND '$l1' AND uid='$uid' AND type = 'Renew' AND form3_status = '1'"))?>
                      ...
                      <div class="card-body">
                        ...
                        <script>
                          ...
                          var yValues = [<?php while($sh_structure3 = $read_structure_query2->fetch_assoc()){
                            ...
                            WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' 
                            AND structure = '".$sh_structure3['structure_id']."' AND uid = '$uid' AND form3_status = '1'"));
                          ...
                          var zValues = [<?php while($sh_structure3 = $read_structure_query3->fetch_assoc()){
                            ...
                            AND uid = '$uid' AND form3_status = '1'"));
                            echo $count_read_structure_query['COUNT(form3_id)'] . ",";
                  ...
                  WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND new_renew = 'New' 
                  AND with_or_not = 'FSIC Issued WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  <?php $newfsic2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                  WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND new_renew = 'New' 
                  AND with_or_not = 'FSIC Issued NOT WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  <?php $renewfsic1 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                  WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND new_renew = 'Renew' 
                  AND with_or_not = 'FSIC Issued WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  ...
                  WHERE form3_date_added BETWEEN '$l' AND '$l1' AND '$lday' AND new_renew = 'New' 
                  AND with_or_not = 'FSIC Issued NOT WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  <?php $renewfsic1_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                  WHERE form3_date_added BETWEEN '$l' AND '$l1' AND '$lday' AND new_renew = 'Renew' 
                  AND with_or_not = 'FSIC Issued WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  <?php $renewfsic2_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                  WHERE form3_date_added BETWEEN '$l' AND '$l1' AND '$lday' AND new_renew = 'Renew' 
                  AND with_or_not = 'FSIC Issued NOT WITHIN Prescribed Period' AND uid = '$uid' AND form3_status = '1'"))?>
                  <h3 class="text-center mt-3 mb-3">
                    Total FSIC Issued : <b><?php echo $fsictotal = $newfsic1['COUNT(form3_id)'] + $newfsic2['COUNT(form3_id)'] + $renewfsic1['COUNT(form3_id)'] + $renewfsic2['COUNT(form3_id)']?></b>
                    <?php echo $fsictotal_l = $newfsic1_l['COUNT(form3_id)'] + $newfsic2_l['COUNT(form3_id)'] + $renewfsic1_l['COUNT(form3_id)'] + $renewfsic2_l['COUNT(form3_id)']?>
                  </h3>
                  <div class="col-lg-6 mt-3">
                    <div class="card">
                      <div class="card-body">
                  ...
                  <div class="col-lg-4 mt-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued NTC' AND uid = '$uid' AND form3_status = '1'"));
                        $reinspect2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued FSIC for Business Operation' AND uid = '$uid' AND form3_status = '1'"));
                        ?>
                  ...
                  <div class="col-lg-4 mt-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued NTCV' AND uid = '$uid' AND form3_status = '1'"));
                        $reinspect4 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued FSIC for Business Operation' AND uid = '$uid' AND form3_status = '1'"));
                        ?>
                  ...
                  <div class="col-lg-4 mt-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'ABATEMENT' AND reinspection_3='Issued Abatement Order' AND uid = '$uid' AND form3_status = '1'"));
                        $reinspect6 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        reinspection_1 = 'ABATEMENT' AND reinspection_3='Total Issued FSIC for Business/ Operation' AND uid = '$uid' AND form3_status = '1'"));
                        ?>
                  ...
                  <div class="col-lg-6 mt-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        closure = 'Closure Order for Failure to Comply the Abatement order' AND uid = '$uid' AND form3_status = '1'"));
                        $form2_closure2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3
                        WHERE form3_date_added BETWEEN '$searchyear-$searchmonth-01' AND '$lday' AND 
                        closure = 'Closure For Failure To Pay Fine' AND uid = '$uid' AND form3_status = '1'"));
