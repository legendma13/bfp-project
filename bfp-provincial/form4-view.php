                      ...
                      <div class="card mb-3">
                        <div class="card-body">
                          ...
                          <dl class="row">
                            ...
                            <dt class="col-lg-9">
                              <input type="text" class="form-control mb-3" value="<?php echo $report['brgy']?>" readonly>
                            </dt>
                            <dt class="col-lg-3 fs-6">Choose What Type :</dt>
                            <dt class="col-lg-9">
                              <input type="text" class="form-control mb-3" value="<?php echo $report['type']?>" readonly>
                            </dt>
                            <dt class="col-lg-3 fs-6">FIRE CODE FEES COLLECTION</dt>
                            <dt class="col-lg-9">
                              <input type="text" class="form-control mb-3" value="<?php echo $report['fire_code_fees']?>" readonly>
                            </dt>
                            <dt class="col-lg-3 fs-6">Fee</dt>
                            <dt class="col-lg-9">
                              <input type="text" class="form-control" value="<?php echo $report['fees']?>" readonly>
                            </dt>
                          </dl>                          
                          <div class="row">
