                  ...
                  <div class="tab-content tab-content-basic">
                    <div class="tab-pane fade" id="Overview" role="tabpanel" aria-labelledby="Overview">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <div class="card">
                            <div class="card-body">
                              <div id="lastyearvcurrent" style="width:300px;"></div>
                              <script>
                    ...
                    <div class="tab-pane fade show active" id="newBldg" role="tabpanel" aria-labelledby="newBldg"> 
                      ...
                      <div class="row mb-3" id="newstabshow">
                        ...
                        ?>
                        <?php $query = mysqli_query($link,"SELECT * FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid' AND Form1Type='".$_GET['typethis']."'")?>
                        ...
                        <div class="col-md-12 grid-margin grid-margin-md-0 stretch-card mb-3">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <?php
                                    $s1 = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(Assembly),SUM(Educational),SUM(DayCare),SUM(HealthCare),
                                    SUM(ResidentialBoardandCare),SUM(DetentionandCorrectional),SUM(Hotel),SUM(Dormitories),SUM(ApartmentBuilding),
                                    SUM(LodgingandRooming_house),SUM(SingleandTwoFamilyDwellingUnit),SUM(Mercantile),SUM(Business),SUM(Industrial),
                                    SUM(Storage),SUM(SpecialStructures) FROM structure_data WHERE uid='$uid' AND structure_type = 'NC'"));
                                    
                                    $s2 = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(Assembly),SUM(Educational),SUM(DayCare),SUM(HealthCare),
                                    SUM(ResidentialBoardandCare),SUM(DetentionandCorrectional),SUM(Hotel),SUM(Dormitories),SUM(ApartmentBuilding),
                                    SUM(LodgingandRooming_house),SUM(SingleandTwoFamilyDwellingUnit),SUM(Mercantile),SUM(Business),SUM(Industrial),
                                    SUM(Storage),SUM(SpecialStructures) FROM structure_data WHERE uid='$uid' AND structure_type = 'RN'"));
                                  ...
                                  <script>
                                      ...
                                      var yArray = [
                                         <?php 
                                         echo $s1['SUM(Assembly)'].',';
                                         echo $s1['SUM(Educational)'].',';
                                         echo $s1['SUM(DayCare)'].',';
                                         echo $s1['SUM(HealthCare)'].',';
                                         echo $s1['SUM(ResidentialBoardandCare)'].',';
                                         echo $s1['SUM(DetentionandCorrectional)'].',';
                                         echo $s1['SUM(Hotel)'].',';
                                         echo $s1['SUM(Dormitories)'].',';
                                         echo $s1['SUM(ApartmentBuilding)'].',';
                                         echo $s1['SUM(LodgingandRooming_house)'].',';
                                         echo $s1['SUM(SingleandTwoFamilyDwellingUnit)'].',';
                                         echo $s1['SUM(Mercantile)'].',';
                                         echo $s1['SUM(Business)'].',';
                                         echo $s1['SUM(Industrial)'].',';
                                         echo $s1['SUM(Storage)'].',';
                                         echo $s1['SUM(SpecialStructures)'];
                                          ?>
                                      ];
                                      var aArray = [
                                      ...
                                      var bArray = [
                                        <?php
                                          echo $s2['SUM(Assembly)'].',';
                                          echo $s2['SUM(Educational)'].',';
                                          echo $s2['SUM(DayCare)'].',';
                                          echo $s2['SUM(HealthCare)'].',';
                                          echo $s2['SUM(ResidentialBoardandCare)'].',';
                                          echo $s2['SUM(DetentionandCorrectional)'].',';
                                          echo $s2['SUM(Hotel)'].',';
                                          echo $s2['SUM(Dormitories)'].',';
                                          echo $s2['SUM(ApartmentBuilding)'].',';
                                          echo $s2['SUM(LodgingandRooming_house)'].',';
                                          echo $s2['SUM(SingleandTwoFamilyDwellingUnit)'].',';
                                          echo $s2['SUM(Mercantile)'].',';
                                          echo $s2['SUM(Business)'].',';
                                          echo $s2['SUM(Industrial)'].',';
                                          echo $s2['SUM(Storage)'].',';
                                          echo $s2['SUM(SpecialStructures)'];
                                          ?>
                                      ];
                                      var data = [{
                                          x:xArray,
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6 border border-2 rounded">
                                          ...
                                          <?php $structure_NC = mysqli_fetch_assoc(mysqli_query($link,"SELECT * FROM structure_data WHERE report_id = '".$shnewestablish['form_id']."' AND structure_type = 'NC' AND type ='$type' LIMIT 1"))?>
                                          <?php $structure_RN = mysqli_fetch_assoc(mysqli_query($link,"SELECT * FROM structure_data WHERE report_id = '".$shnewestablish['form_id']."' AND structure_type = 'RN' AND type ='$type' LIMIT 1"))?>
                                          
                                          <?php 
                                           $totalNC = $s1['SUM(Assembly)']+
                                           $s1['SUM(Educational)']+
                                           $s1['SUM(DayCare)']+
                                           $s1['SUM(HealthCare)']+
                                           $s1['SUM(ResidentialBoardandCare)']+
                                           $s1['SUM(DetentionandCorrectional)']+
                                           $s1['SUM(Hotel)']+
                                           $s1['SUM(Dormitories)']+
                                           $s1['SUM(ApartmentBuilding)']+
                                           $s1['SUM(LodgingandRooming_house)']+
                                           $s1['SUM(SingleandTwoFamilyDwellingUnit)']+
                                           $s1['SUM(Mercantile)']+
                                           $s1['SUM(Business)']+
                                           $s1['SUM(Industrial)']+
                                           $s1['SUM(Storage)']+
                                           $s1['SUM(SpecialStructures)'];
                                          
                                          $totalRN = $s2['SUM(Assembly)']+
                                           $s2['SUM(Educational)']+
                                           $s2['SUM(DayCare)']+
                                           $s2['SUM(HealthCare)']+
                                           $s2['SUM(ResidentialBoardandCare)']+
                                           $s2['SUM(DetentionandCorrectional)']+
                                           $s2['SUM(Hotel)']+
                                           $s2['SUM(Dormitories)']+
                                           $s2['SUM(ApartmentBuilding)']+
                                           $s2['SUM(LodgingandRooming_house)']+
                                           $s2['SUM(SingleandTwoFamilyDwellingUnit)']+
                                           $s2['SUM(Mercantile)']+
                                           $s2['SUM(Business)']+
                                           $s2['SUM(Industrial)']+
                                           $s2['SUM(Storage)']+
                                           $s2['SUM(SpecialStructures)'];?>
                                          
                                          <script>
                                          var xArray = ["Total NC", "Total RN"];
                                          var yArray = [<?php echo $totalNC?>, <?php echo $totalRN?>];
                                      ...
                                      <div class="col-lg-6 border border-2 rounded">
                                          ...
                                          <?php $lastmonth = date('Y-m-d', strtotime($now. ' + 1 day'));?>
                                          <script>
                                          var xArray = ["Previous Month Overall", "Current Month Overall"];
                                          var yArray = [0 , <?php echo $currenttotal = $totalNC + $totalRN?>];
                                  ...
                                  <div class="row mt-3">
                                      <div class="col-lg-12">
                                          ...
                                          <script>
                                          <?php
                                            $fsiccur = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedFSIC_CurMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $fsicpre = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedFSIC_PreMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $fsicadd = $fsiccur['SUM(IssuedFSIC_CurMonth)'] + $fsicpre['SUM(IssuedFSIC_PreMonth)'];

                                            $fsicnodpre = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedwithNOD_PreMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $fsicnodcur = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedwithNOD_CurMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $nodadd = $fsicnodpre['SUM(IssuedwithNOD_PreMonth)'] + $fsicnodcur['SUM(IssuedwithNOD_CurMonth)'];
                                          
                                            $fsicNTCpre = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedwithNTC_PreMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $fsicNTCcur = mysqli_fetch_assoc(mysqli_query($link,"SELECT SUM(IssuedwithNTC_CurMonth) FROM form1 WHERE report_created BETWEEN '$searchyear-$searchmonth-1 00-00-01' AND '$searchyear-$searchmonth-31 23-59-59' AND uid='$uid'"));
                                            $NTCadd = $fsicNTCpre['SUM(IssuedwithNTC_PreMonth)'] + $fsicNTCcur['SUM(IssuedwithNTC_CurMonth)'];
                                          ?>
                                          ...
                                          var yArray = [<?php echo $fsiccur['SUM(IssuedFSIC_CurMonth)']?>, <?php echo $fsicnodcur['SUM(IssuedwithNOD_CurMonth)']?>,<?php echo $fsicNTCcur['SUM(IssuedwithNTC_CurMonth)']?> ];
                                          ...
                                          var bArray = [<?php echo $fsicpre['SUM(IssuedFSIC_PreMonth)']?>,<?php echo $fsicnodpre['SUM(IssuedwithNOD_PreMonth)']?>,  <?php echo $fsicNTCpre['SUM(IssuedwithNTC_PreMonth)']?> ];
                                          ...
                                          var dArray = [<?php echo $fsicadd?>, <?php echo $nodadd?>,<?php echo $NTCadd?> ];
