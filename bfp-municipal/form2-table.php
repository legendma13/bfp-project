              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-sm-flex align-items-center justify-content-between">
                    <div>
                      <h4 class="card-title">Business Establishment Table</h4>
                    </div>
                    <div>
                      <a href="form2.php"><button class="btn btn-info me-0">Add Data</button></a>
                    </div>
                  </div>
                  <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                      ...
                      <tbody>
                        ...
                        WHERE uid = '$uid' ORDER BY form2_date_added DESC")?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button type="button" value="<?php echo $shform2_data['form2_id']?>" class="form2removereport badge bg-danger ps-3 pe-3">Remove</button>
                          </td>
                        </tr>
                        <?php }?>
                      </tbody>
