...
<body>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center justify-content-between">
                      <div>
                        <h4 class="card-title">Provincial Report Table</h4>
                      </div>
                      <div>
                    ...
                    <div class="table-responsive">
                      <table id="reporttable" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          LEFT JOIN bfp_users ON bfp_users.uid = m_report.M_uid ORDER BY M_report_submit DESC")?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="province-report.php?rid=<?php echo $shform1['M_report_id']?>&start=<?php echo $shform1['M_start_report']?>&end=<?php echo $shform1['M_end_report']?>">
  ...
  <script>
    ...
    $(document).on("submit", "#reportform", function (e) {
      ...
      formData.append("sM_end_report", true);
      $.ajax({
        type: "POST",
