...
<body>
  <div class="container-scroller">
    <?php $report = mysqli_fetch_assoc(mysqli_query($link,"SELECT * FROM bfp_form2 WHERE form2_id = '".$_GET['reportid']."' LIMIT 1"))?>
                          ...
                          <dt class="col-lg-9">
                            <select name="structure" id="structure" class="form-select" required>
                              ...
                              <?php while($sh_structure = $read_structure_query->fetch_assoc()){?>
                                ...
                                <?php }?>
                              <?php }?>
                              <option value="0">Non-Structural</option>
                            </select>
                          </dt>
                        </dl>
                        <dl class="row">
                          ...
                          <dt class="col-lg-4">
                            New or Renewal
                            <select name="fsic" id="fsic" class="form-select" required>
                              <option value="">--choose--</option>
                              <?php if($report['fsic'] == "New"){?>
                                <option value="New" selected>New</option>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <dl class="row">
                          ...
                          <dt class="col-lg-9">
                            <select name="closure" id="closure" class="form-select" required>
                              <option value="">--choose--</option>
                        ...
                        <script>
                          ...
                          function reinspect2(s1){
                            ...
                            if (s1.value == "Compliant" && reins1.value == "NOTICE TO COMPLY") {
                              s2.value = "Issued NTC";
                            } else if(s1.value == "Non-Conpliant" && reins1.value == "NOTICE TO COMPLY") {
                            ...
                            } else if(s1.value == "Non-Conpliant" && reins1.value == "NOTICE TO CORRECT VIOLATION") {
                              s2.value = "Issued FSIC for Business Operation";
                            } else if (s1.value == "Compliant" && reins1.value == "ABATEMENT") {
                              s2.value = "Issued Abatement Order";
                            } else if(s1.value == "Non-Conpliant" && reins1.value == "ABATEMENT") {
