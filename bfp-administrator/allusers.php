    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h1 class="h3 mb-3">All Registered User</h1>
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb border border-0">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">All Registered User</li>
            </ol>
          </nav>
          <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                      <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          WHERE status='true' and position != 'Admin' ORDER BY date_created DESC")?>
