                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center justify-content-between">
                      <div>
                        <h4 class="card-title">New Building Table</h4>
                      </div>
                      <div>
                        <a href="form1.php"><button class="btn btn-info me-0">Add Data</button></a>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          WHERE uid='$uid' ORDER BY form1_date_added DESC") ?>
                          <?php while ($shform1 = mysqli_fetch_assoc($Qform1)) { ?>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <button type="button" value="<?php echo $shform1['form1_id'] ?>" class="form1-removedata badge bg-danger ps-3 pe-3">Remove</button>
                              </td>
                            </tr>
                          <?php } ?>
                        </tbody>
