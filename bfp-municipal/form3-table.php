...
<script>
  $(document).ready(function() {
    ...
    buttons: [
      {
        extend: 'print',
        title: "Government Building Table",
        exportOptions: {
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <h1 class="h3 mb-3">Government Building</h1>
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb border border-0">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Government Building</li>
            </ol>
          </nav>
          <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center justify-content-between">
                      <div>
                        <h4 class="card-title">Government Building Table</h4>
                      </div>
                      <div>
                        <a href="form3.php"><button class="btn btn-info me-0">Add Data</button></a>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            WHERE uid = '$uid' ORDER BY form3_date_added DESC")?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <button type="button" value="<?php echo $shform3_data['form3_id']?>" class="form3removereport badge bg-danger ps-3 pe-3">Remove</button>
                            </td>
                          </tr>
                          <?php }?>
                        </tbody>
