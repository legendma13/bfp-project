            ...
            <div class="col-sm-12">
              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <?php
                        ...
                        WHERE form1_date_added BETWEEN '$start' AND '$end' AND bfp_users.uid = '".$report['uid']."'
                        AND type='New Establishments Buildings'"));
                        $counttotalpeb = mysqli_fetch_array($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                        LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                        WHERE form1_date_added BETWEEN '$l' AND '$l1' AND bfp_users.uid = '".$report['uid']."'
                        AND type='New Establishments Buildings'"));
                        ...
                        <div class="card-body">
                          ...
                          <script>
                            ...
                            var zstrarray = [<?php
                              ...
                              LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                              WHERE form1_date_added BETWEEN '$start' AND '$end' 
                              AND structure = '".$sh_structure['structure_id']."' AND nc_or_rn='RN' AND bfp_users.uid = '".$report['uid']."'"));
                            ...
                            var Pstrarray = [<?php
                              ...
                              AND structure = '".$sh_structure['structure_id']."' AND nc_or_rn='NC' AND bfp_users.uid='".$report['uid']."'"));
                    ...
                    <div class="col-lg-8 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND inspection = 'NC' AND bfp_users.uid = '".$report['uid']."'"));
                          $underRN = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid

                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND inspection = 'RN' AND bfp_users.uid = '".$report['uid']."'"));
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued FSIC for Occupancy' AND bfp_users.uid = '".$report['uid']."'"));
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued With NOD for NOT OCCUPIED buildings/establishments' AND bfp_users.uid = '".$report['uid']."'"));
                          $PMoccupancy = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued With NTC for OCCUPIED buildings/establishments' AND bfp_users.uid = '".$report['uid']."'"));
                          $PMoccupancy = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                ...
                <div class="col-lg-12" id="form2" style="display: none;">
                          ...
                          <div class="table-responsive">
                            <table id="f2table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE form2_date_added BETWEEN ' $start' AND ' $end' ORDER BY bfp_form2.form2_date_added DESC")?>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN ' $start' AND ' $end' AND bfp_users.uid = '".$report['uid']."' AND type = 'New'"))?>
                          <?php $counttyperenew = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN ' $start' AND ' $end' AND bfp_users.uid = '".$report['uid']."' AND type = 'Renew'"))?>
                          <?php $counttypenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN '$l' AND '$l1' AND bfp_users.uid = '".$report['uid']."' AND type = 'New'"))?>
                          <?php $counttyperenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN '$l' AND '$l1' AND bfp_users.uid = '".$report['uid']."' AND type = 'Renew'"))?>
                  ...
                  AND structure = '0' AND bfp_users.uid = '".$report['uid']."'"));
                      ...
                      <div class="card-body">
                        ...
                        <script>
                          ...
                          var yValues = [<?php while($sh_structure2 = $read_structure_query2->fetch_assoc()){
                            ...
                            WHERE form2_date_added BETWEEN '$start' AND '$end' 
                            AND structure = '".$sh_structure2['structure_id']."' AND bfp_users.uid = '".$report['uid']."'"));
                  ...
                  AND with_or_not = 'FSIC Issued WITHIN Prescribed Period' AND bfp_users.uid = '".$report['uid']."'"))?>
                  <?php $newfsic2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                  LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                  WHERE form2_date_added BETWEEN '$start' AND '$end' AND fsic = 'New' 
                  AND with_or_not = 'FSIC Issued NOT WITHIN Prescribed Period' AND bfp_users.uid = '".$report['uid']."'"))?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued NTC' AND bfp_users.uid = '".$report['uid']."'"));
                          $reinspect2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued FSIC for Business Operation' AND bfp_users.uid = '".$report['uid']."'"));
                          ?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued NTCV' AND bfp_users.uid = '".$report['uid']."'"));
                          $reinspect4 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued FSIC for Business Operation' AND bfp_users.uid = '".$report['uid']."'"));
                          ?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'ABATEMENT' AND reinspection_3='Issued Abatement Order' AND bfp_users.uid = '".$report['uid']."'"));
                          $reinspect6 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'ABATEMENT' AND reinspection_3='Total Issued FSIC for Business/ Operation' AND bfp_users.uid = '".$report['uid']."'"));
                          ?>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          closure = 'Closure Order for Failure to Comply the Abatement order' AND bfp_users.uid = '".$report['uid']."'"));
                          $form2_closure2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          closure = 'Closure For Failure To Pay Fine' AND bfp_users.uid = '".$report['uid']."'"));
                          ...
                          <div class="table-responsive">
                            <table id="f3table" class="table table-striped">
                              ...
                              <tbody>
                                  ...
                                  WHERE form3_date_added BETWEEN '$start' AND '$end' ORDER BY bfp_form3.form3_date_added DESC")?>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form3_date_added BETWEEN '$start' AND '$end' AND bfp_users.uid = '".$report['uid']."' AND type = 'New'"))?>
                          <?php $counttyperenew = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$start' AND '$end' AND bfp_users.uid = '".$report['uid']."' AND type = 'Renew'"))?>
                          <?php $counttypenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$l' AND '$l1' AND bfp_users.uid = '".$report['uid']."' AND type = 'New'"))?>
                          <?php $counttyperenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$l' AND '$l1' AND bfp_users.uid = '".$report['uid']."' AND type = 'Renew'"))?>
                      ...
                      <div class="card-body">
                        ...
                        <script>
                          ...
                          var yValues = [<?php while($sh_structure3 = $read_structure_query2->fetch_assoc()){
                            ...
                            AND structure = '".$sh_structure3['structure_id']."' AND bfp_users.uid = '".$report['uid']."'"));
                ...
                <div class="col-lg-12" id="form4" style="display: none;">
                          ...
                          <div class="table-responsive">
                            <table id="f4table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE bfp_users.uid = '".$report['uid']."' AND form4_date_added BETWEEN '$start' AND '$end' 
                  ...
                  <script>
                  var xValues = [<?php foreach ($feesarray as $sharray) { echo "'" . $sharray . "',";} ?>];
                  var yValues = [<?php foreach ($feesarray as $sharray1) {
                                  ...
                                  AND fire_code_fees = '$sharray1' AND bfp_users.uid = '".$report['uid']."'"));
                  ...
                  var zValues = [<?php foreach ($feesarray as $sharray2) {
                                  ...
                                  AND fire_code_fees = '$sharray2' AND bfp_users.uid = '".$report['uid']."'"));
                                  echo $count['COUNT(fire_code_fees)'].",";
                  } ?>];
