                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center justify-content-between">
                      <div>
                        <h4 class="card-title">Fire Code Fees Collection Table</h4>
                      </div>
                    </div>
                    <div class="table-responsive">
                      <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                          ...
                          WHERE form4_status = '1' ORDER BY bfp_form4.form4_date_added DESC")?>
                          ...
                          <tr>
                            ...
                            <td><?php echo $shform4_data['location'] ?></td>
                            <td><?php echo $shform4_data['municipal'] ?></td>
