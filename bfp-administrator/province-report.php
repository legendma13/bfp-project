          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="row mt-3 mb-3">
                <div class="col-lg-12">
                  <?php $report = mysqli_fetch_assoc($link->query("SELECT * FROM m_report 
                  LEFT JOIN bfp_users ON m_report.M_uid = bfp_users.uid 
                  WHERE m_report.M_report_id = '".$_GET['rid']."'"))?>
                  <h3><?php echo $report['location']?> Report for <?php echo date('Y-F',strtotime($report['M_start_report']))?></h3>
                  <small><?php echo $report['M_details']?></small>
                </div>
              </div>
              <!-- Report -->
              <div class="row">
                          ...
                          <div class="table-responsive">
                            <table id="f1table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE form1_date_added BETWEEN '$start' AND '$end' AND bfp_users.municipal = '".$report['location']."' 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <?php
                        ...
                        LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                        WHERE form1_date_added BETWEEN '$l' AND '$l1' AND bfp_users.municipal = '".$report['location']."' 
                        AND type='New Establishments Buildings'"));
                        ...
                        <div class="card-body">
                          ...
                          <script>
                            ...
                            var ystrarray = [<?php
                              ...
                              AND bfp_users.municipal = '".$report['location']."' "));
                            ...
                            var zstrarray = [<?php
                              ...
                              LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                              WHERE form1_date_added BETWEEN '$start' AND '$end' 
                              AND structure = '".$sh_structure['structure_id']."' AND nc_or_rn='RN' AND bfp_users.municipal = '".$report['location']."' "));
                            ...
                            var Pstrarray = [<?php
                              ...
                              AND structure = '".$sh_structure['structure_id']."' AND nc_or_rn='NC' AND bfp_users.municipal='".$report['location']."' "));
                    ...
                    <div class="col-lg-8 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND inspection = 'NC' AND bfp_users.municipal='".$report['location']."' "));
                          $underRN = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND inspection = 'RN' AND bfp_users.municipal='".$report['location']."' "));
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued FSIC for Occupancy' AND bfp_users.municipal='".$report['location']."' "));
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued With NOD for NOT OCCUPIED buildings/establishments' AND bfp_users.municipal='".$report['location']."' "));
                          $PMoccupancy = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$l' AND '$l1'
                          AND issuance = 'Issued With NOD for NOT OCCUPIED buildings/establishments' AND bfp_users.municipal='".$report['location']."' "));
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$start' AND '$end'
                          AND issuance = 'Issued With NTC for OCCUPIED buildings/establishments' AND bfp_users.municipal='".$report['location']."' "));
                          $PMoccupancy = mysqli_fetch_assoc($link->query("SELECT COUNT(form1_id) FROM bfp_form1 
                          LEFT JOIN bfp_users ON bfp_form1.uid = bfp_users.uid
                          WHERE form1_date_added BETWEEN '$l' AND '$l1'
                          AND issuance = 'Issued With NTC for OCCUPIED buildings/establishments' AND bfp_users.municipal='".$report['location']."' "));
                ...
                <div class="col-lg-12" id="form2" style="display: none;">
                          ...
                          <div class="table-responsive">
                            <table id="f2table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE form2_date_added BETWEEN ' $start' AND ' $end' AND bfp_users.municipal='".$report['location']."' 
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $shform2_data['location'] ?></td>
                                  <td><?php echo $shform2_data['municipal'] ?></td>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN ' $start' AND ' $end' AND bfp_users.municipal='".$report['location']."'  AND type = 'New'"))?>
                          <?php $counttyperenew = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN ' $start' AND ' $end' AND bfp_users.municipal='".$report['location']."'  AND type = 'Renew'"))?>
                          <?php $counttypenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN '$l' AND '$l1' AND bfp_users.municipal='".$report['location']."'  AND type = 'New'"))?>
                          <?php $counttyperenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                          LEFT JOIN bfp_users ON bfp_users.uid = bfp_form2.uid
                          WHERE form2_date_added BETWEEN '$l' AND '$l1' AND bfp_users.municipal='".$report['location']."'  AND type = 'Renew'"))?>
                  ...
                  AND structure = '0' AND bfp_users.municipal='".$report['location']."' AND bfp_users.location = '".$report['location']."'"));
                      ...
                      <div class="card-body">
                        ...
                        <script>
                          ...
                          var yValues = [<?php while($sh_structure2 = $read_structure_query2->fetch_assoc()){
                            ...
                            WHERE form2_date_added BETWEEN '$start' AND '$end' 
                            AND structure = '".$sh_structure2['structure_id']."' AND bfp_users.municipal='".$report['location']."'
                            "));
                  ...
                  AND with_or_not = 'FSIC Issued WITHIN Prescribed Period' AND bfp_users.municipal='".$report['location']."' "))?>
                  <?php $newfsic2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2 
                  LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                  WHERE form2_date_added BETWEEN '$start' AND '$end' AND fsic = 'New' 
                  AND with_or_not = 'FSIC Issued NOT WITHIN Prescribed Period' AND bfp_users.municipal='".$report['location']."' "))?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued NTC' AND bfp_users.municipal='".$report['location']."' "));
                          $reinspect2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO COMPLY' AND reinspection_3='Issued FSIC for Business Operation' AND bfp_users.municipal='".$report['location']."' "));
                          ?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued NTCV' AND bfp_users.municipal='".$report['location']."' "));
                          $reinspect4 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'NOTICE TO CORRECT VIOLATION' AND reinspection_3='Issued FSIC for Business Operation' AND bfp_users.municipal='".$report['location']."' "));
                          ?>
                    ...
                    <div class="col-lg-4 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'ABATEMENT' AND reinspection_3='Issued Abatement Order' AND bfp_users.municipal='".$report['location']."' "));
                          $reinspect6 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          reinspection_1 = 'ABATEMENT' AND reinspection_3='Total Issued FSIC for Business/ Operation' AND bfp_users.municipal='".$report['location']."' "));
                          ?>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          closure = 'Closure Order for Failure to Comply the Abatement order' AND bfp_users.municipal='".$report['location']."' "));
                          $form2_closure2 = mysqli_fetch_assoc($link->query("SELECT COUNT(form2_id) FROM bfp_form2
                          LEFT JOIN bfp_users ON bfp_form2.uid = bfp_users.uid
                          WHERE form2_date_added BETWEEN '$start' AND '$end' AND 
                          closure = 'Closure For Failure To Pay Fine' AND bfp_users.municipal='".$report['location']."' "));
                          ...
                          <div class="table-responsive">
                            <table id="f3table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE form3_date_added BETWEEN '$start' AND '$end' AND bfp_users.municipal='".$report['location']."' 
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $shform3_data['location'] ?></td>
                                  <td><?php echo $shform3_data['municipal'] ?></td>
                    ...
                    <div class="col-lg-6 mt-3">
                      <div class="card">
                        <div class="card-body">
                          ...
                          WHERE form3_date_added BETWEEN '$start' AND '$end' AND bfp_users.municipal='".$report['location']."'  AND type = 'New'"))?>
                          <?php $counttyperenew = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$start' AND '$end' AND bfp_users.municipal='".$report['location']."'  AND type = 'Renew'"))?>
                          <?php $counttypenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$l' AND '$l1' AND bfp_users.municipal='".$report['location']."'  AND type = 'New'"))?>
                          <?php $counttyperenew_l = mysqli_fetch_assoc($link->query("SELECT COUNT(form3_id) FROM bfp_form3 
                          LEFT JOIN bfp_users ON bfp_form3.uid = bfp_users.uid
                          WHERE form3_date_added BETWEEN '$l' AND '$l1' AND bfp_users.municipal='".$report['location']."'  AND type = 'Renew'"))?>
                      ...
                      <div class="card-body">
                        ...
                        <script>
                          ...
                          var yValues = [<?php while($sh_structure3 = $read_structure_query2->fetch_assoc()){
                            ...
                            AND structure = '".$sh_structure3['structure_id']."' AND bfp_users.municipal='".$report['location']."' "));
                ...
                <div class="col-lg-12" id="form4" style="display: none;">
                 ...
                 "Certificate of Competency (COC) Fees");?>
                          ...
                          <div class="table-responsive">
                            <table id="f4table" class="table table-striped">
                              ...
                              <tbody>
                                ...
                                WHERE form4_date_added BETWEEN '$start' AND '$end' AND  bfp_users.municipal='".$report['location']."'
                                ORDER BY form4_date_added DESC")?>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card">
                        <div class="chart-container card-body" style="position: relative;height:auto; width:80vw">
                  ...
                  var yValues = [<?php foreach ($feesarray as $sharray1) {
                                  $count = mysqli_fetch_assoc($link->query("SELECT COUNT(fire_code_fees) 
                                  FROM bfp_form4 LEFT JOIN bfp_users ON bfp_form4.uid = bfp_users.uid
                                  WHERE form4_date_added BETWEEN '$start' AND '$end' 
                                  AND fire_code_fees = '$sharray1' AND bfp_users.municipal='".$report['location']."' "));
                                  echo $count['COUNT(fire_code_fees)'].",";
                                } ?>];
                  var zValues = [<?php foreach ($feesarray as $sharray2) {
                                  ...
                                  AND fire_code_fees = '$sharray2' AND bfp_users.municipal='".$report['location']."' "));
                                  echo $count['COUNT(fire_code_fees)'].",";
                  } ?>];
                  ...
                  <div class="row mt-3">
                    <div class="col-lg-12 text-end">
                      <div class="dropdown">
                        ...
                        <?php if($report['M_report_status'] == "Requesting"){?>
